...
import sys
sys.path.append('/home/liusy/MachineLearning_CSGD/S2S_SubX_Multimodel_250525/03_Unet++_newTest_251209/UNetPP-A-WeightPredictor-T')
...
class UnetPlusPlus(nn.Module):
    ...
    def __init__(self, in_ch_list, temperature, deep_supervision=False):
        ...
        # Unet++ backbone 公共下采样
        # self.stage0 = ContinusParalleConv(128, 512, pre_Batch_Norm=False)
