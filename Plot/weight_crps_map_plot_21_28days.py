...
for m in range(n_model):
    ...
    for t in range(n_col):
        ...
        # -------------------------
            ...
            if t == 1:
                crps_vmin, crps_vmax = 0, 60
            elif t == 3:
                crps_vmin, crps_vmax = 0, 80
...
# 保存
fig.savefig(f'/home/liusy/MachineLearning_CSGD/S2S_SubX_Multimodel_250525/03_Unet++_newTest_251209/00_pic/93-9-2_weight_crps_map_plot_21_28days.jpg', 
